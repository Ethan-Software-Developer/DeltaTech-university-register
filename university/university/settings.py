...
SECRET_KEY = env.str('DJANGO_SECRET_KEY', default='django-insecure-default-secret-key')
...
X_FRAME_OPTIONS = 'DENY'  # Prevents embedding of your site in a frame (clickjacking protection)
